...
export const en = {
  ...
  chat: {
    ...
    pendingQueueLabel: 'Queued follow-ups',
    followUpChips: {
      code_explain: 'Explain this code',
      code_refactor: 'Refactor it',
      web_more_details: 'Find more details',
      generic_simpler_terms: 'Make it simpler',
      generic_concrete_example: 'Give an example',
      generic_bullet_points: 'Summarize as bullets',
