...
export const en = {
  ...
  homePage: {
    ...
    viewAll: 'View all',
    createNote: 'New note',
    createNoteHint: 'Create a blank note',
  ...
  notesPage: {
    ...
    aiContextScopeSource: 'Markdown source',
    ...
    editorToolbarAi: 'AI',
    editorModeEditHint: 'Structured body editing. Switch to Markdown for frontmatter or exact syntax.',
    editorModeSourceHint: 'Raw Markdown source. Use Edit for smoother mobile writing.',
    editorUnsupportedMarkdownTitle: 'Some content uses complex Markdown',
    editorUnsupportedMarkdownDescription: 'It will be preserved as-is. Switch to Markdown when you need exact edits.',
    editorUnsupportedMarkdownAction: 'Open Markdown',
    editorUnsupportedMarkdownCount: '{{count}} source-edit item(s)',
