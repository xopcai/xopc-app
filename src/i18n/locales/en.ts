...
export const en = {
  ...
  chat: {
    ...
    fileReferenceExternalBadge: 'Gateway device',
    fileReferenceExternalDescription: 'This file is on the computer running the gateway. Mobile cannot open host paths directly.',
