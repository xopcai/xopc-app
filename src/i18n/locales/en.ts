...
export const en = {
  ...
  homePage: {
    ...
    inboxNewCaptureHint: 'New captures will appear here first.',
  ...
  notesPage: {
    ...
    editorBlockCallout: 'Callout',
    editorBlockToggle: 'Toggle',
    editorBlockCode: 'Code block',
    editorBlockNumberedList: 'Numbered list',
    editorBlockDivider: 'Divider',
    editorToolbarBlocks: 'Blocks',
    editorToolbarFormat: 'Format',
    editorToolbarLinks: 'Links',
    editorToolbarAi: 'AI',
    editorPlaceholderText: 'Type something…',
    editorPlaceholderHeading: 'Heading',
    editorPlaceholderTodo: 'To-do item',
    editorPlaceholderSlash: 'Type / for commands…',
    editorEmptyTapHint: 'Tap to start writing',
    editorBlockHandleHint: 'Long press to select blocks',
    editorMentionFilter: 'Link a note',
    editorMentionEmpty: 'No matching notes',
    editorAddBlock: 'Add block',
    editorDeleteBlock: 'Delete block',
    editorMoveBlock: 'Move',
    editorIndentBlock: 'Indent',
    editorOutdentBlock: 'Outdent',
    editorMoveTapCancel: 'Tap here to cancel',
    editorTurnInto: 'Turn into',
    editorDuplicate: 'Duplicate',
    editorCopyBlocks: 'Copy',
    editorPasteBlocks: 'Paste',
    editorPastedBlocks: 'Pasted blocks',
    editorSlashFilter: 'Filter…',
    editorSlashNoMatch: 'No matching blocks',
    editorBlockMenuTitle: 'Actions',
    editorBlockTypeImage: 'Image',
    editorInsertBelow: 'Insert below',
    editorReplaceImage: 'Replace',
    editorCaption: 'Caption',
    editorCaptionPlaceholder: 'Add a caption…',
    editorAlign: 'Alignment',
    editorAlignLeft: 'Left',
    editorAlignCenter: 'Center',
    editorAlignFull: 'Full width',
    editorMoreOptions: 'More options',
    editorCopyImageLink: 'Copy image link',
    editorImageLinkCopied: 'Image link copied',
    editorBlockDeleted: 'Block deleted',
    editorUndoBlockDelete: 'Undo',
    editorUndo: 'Undo',
    editorRedo: 'Redo',
    editorFormatBold: 'Bold',
    editorFormatItalic: 'Italic',
    editorFormatCode: 'Inline code',
    editorTurnIntoUnavailable: 'Coming soon',
    editorAiImageBlockHint: 'Help me with this image block…',
    ...
    editorImageTapToPreview: 'Tap to preview image',
    editorImageExpand: 'Expand image',
    editorImageCollapse: 'Collapse image',
    editorImageRemove: 'Remove image',
