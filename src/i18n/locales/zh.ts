...
export const zh: MessageBundle = {
  ...
  chat: {
    ...
    followUpChipCodeExplain: '逐步解释这段代码。',
    followUpChipCodeOptimize: '建议性能优化方案。',
    followUpChipWebMoreDetails: '搜索更多详情。',
    followUpChipWebFindSources: '查找可靠来源。',
    followUpChipShorterSummary: '给一段更短的摘要。',
    followUpChipMainRisks: '主要风险有哪些？',
    followUpChipEmailMakeFormal: '语气更正式。',
    followUpChipEmailShorten: '精简这段内容。',
    followUpChipSimplerTerms: '用更通俗的话解释一下。',
    followUpChipConcreteExample: '举一个具体例子。',
    followUpChipBulletPoints: '整理为要点列表。',
    followUpChipCreateTable: '以表格形式呈现。',
    followUpChipWhatNext: '我接下来该做什么？',
    followUpChipCodeAddTests: '补充测试覆盖。',
    followUpChipCodeFixError: '定位并修复错误。',
    followUpChipWebVerifyClaim: '核实关键说法。',
    followUpChipResearchDeeper: '深入检索资料。',
    followUpChipGenericActionChecklist: '整理为行动清单。',
    followUpChipGenericAssumptions: '列出关键假设。',
    followUpChipWfRunChecks: '运行测试或检查。',
    followUpChipWfGitCommit: '起草提交说明。',
    followUpChipWfCompareOptions: '对比各方案。',
    followUpChipWfVerifyAcceptance: '对照目标验收。',
    followUpChipOpsFixConfig: '检查配置问题。',
    followUpChipOpsChannelNext: '验证网关与通道。',
    followUpChipOpsScheduleCron: '设置定时任务。',
    followUpChipLearnTechnicalDetail: '深入技术实现细节。',
    followUpChipLearnBuildWalkthrough: '手把手搭建示例。',
    followUpChipLearnCompareAlternatives: '和其他方案对比。',
