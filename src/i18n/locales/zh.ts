...
export const zh: MessageBundle = {
  ...
  chat: {
    ...
    emptyShortcuts: {
      ...
      plan: '做计划',
      skill: '技能',
      goalSheetTitle: '设定要完成的目标',
      goalSheetHint: '描述你希望助手在多轮对话中持续推进的事项。',
      goalSheetPlaceholder: '例如：本周完成 XX 功能的 MVP 验收',
      goalSheetSubmit: '开始目标任务',
      goalAlreadyActive: '当前已有进行中的目标，请查看上方目标卡片。',
      skillSheetTitle: '选择技能',
      skillSheetEmpty: '网关暂无已启用的技能。',
      skillSheetLoadFailed: '技能列表加载失败。',
      templateThinking: '请使用深度思考，分步骤推理后再给出最终结论。',
      templatePlan: '帮我把这件事拆成可执行的步骤清单，并标注优先级和大致耗时。',
    },
