...
export const zh: MessageBundle = {
  ...
  notesPage: {
    ...
    outline: '大纲',
    links: '链接',
    linkCounts: '{{outgoing}} 个出链 · {{backlinks}} 个反链',
    outgoingLinks: '出链',
    backlinks: '反链',
    noOutgoingLinks: '暂无出链',
    noBacklinks: '暂无反链',
    wikiLinkRecentSubtitle: '选择最近笔记，或直接输入标题。',
    wikiLinkSearchSubtitle: '“{{query}}”的搜索结果',
    wikiLinkSearchPlaceholder: '搜索或输入笔记标题',
    wikiLinkInsertTyped: '插入 [[{{title}}]]',
    wikiLinkNoResults: '没有匹配的笔记',
    searchInNote: '搜索',
    searchPlaceholder: '搜索当前笔记',
    searchNoResults: '没有匹配结果',
    searchResultCount: '{{count}} 个结果',
    noteLinkNotFound: '没有找到“{{title}}”对应的笔记。',
    aiPromptOrganize: '整理成结构化笔记',
    aiPromptExtractTodos: '提取待办事项',
    aiPromptTitleTags: '生成标题和标签',
    aiPromptSummarize: '压缩成摘要',
    aiPromptRewrite: '改写得更清楚',
    aiPromptShorten: '变短一些',
    aiPromptSummarizeSection: '总结当前章节',
    aiPromptOrganizeSection: '整理当前章节',
    aiInputPlaceholder: '告诉 AI 如何整理这篇笔记…',
    aiSuggestionTitle: 'AI 建议',
    aiContextSelection: '正在编辑选中文本',
    aiContextSection: '正在编辑章节：{{heading}}',
    aiContextBlock: '正在编辑当前块',
    aiContextNote: '正在编辑整篇笔记',
    aiContextScope: '作用范围',
    aiContextScopeSelection: '选中文本',
    aiContextScopeSection: '当前章节',
    aiContextScopeBlock: '当前块',
    aiContextScopeNote: '整篇笔记',
    aiContextScopeSource: 'Markdown 源码',
    aiContextPreview: '上下文',
    aiSuggestionReady: '应用前先确认这次修改。',
    aiSuggestionApplied: '已应用 AI 建议。',
    aiSuggestionUndone: '已撤销 AI 建议。',
    aiGeneratePreview: '预览',
    aiPreviewBefore: '修改前',
    aiPreviewAfter: '修改后',
    aiOperationCount: '{{count}} 处修改',
    aiMetadataTitle: '元数据',
    aiMetadataNoteTitle: '标题',
    aiMetadataTags: '标签',
    aiMetadataStatus: '状态',
    aiMetadataFrontmatter: 'Frontmatter',
    aiContentChanges: '正文改动',
    aiNoContentChanges: '正文内容未改动。',
    aiApply: '应用',
    aiDiscard: '放弃',
    ...
    editorBlockQuote: '引用',
    editorBlockCallout: '标注',
    editorBlockToggle: '折叠块',
    editorBlockCode: '代码块',
    editorBlockNumberedList: '编号列表',
    editorBlockDivider: '分割线',
    editorToolbarBlocks: '块',
    editorToolbarFormat: '格式',
    editorToolbarLinks: '链接',
    editorToolbarAi: 'AI',
    editorModeEditHint: '结构化编辑正文块；Frontmatter 或复杂语法可切到 Markdown。',
    editorModeSourceHint: '正在编辑原始 Markdown；日常写作建议使用编辑模式。',
    editorUnsupportedMarkdownTitle: '部分内容使用了复杂 Markdown',
    editorUnsupportedMarkdownDescription: '这些内容会原样保留；需要精确修改时请切到 Markdown。',
    editorUnsupportedMarkdownAction: '打开 Markdown',
    editorUnsupportedMarkdownCount: '{{count}} 处需要源码编辑',
    editorPlaceholderText: '输入内容…',
    editorPlaceholderHeading: '标题',
    editorPlaceholderTodo: '待办事项',
    editorPlaceholderSlash: '输入 / 打开命令菜单…',
    editorEmptyTapHint: '点击开始写作',
    editorBlockHandleHint: '长按 ⋮⋮ 选择多个块',
    editorMentionFilter: '链接笔记',
    editorMentionEmpty: '没有匹配的笔记',
    editorAddBlock: '添加块',
    editorDeleteBlock: '删除块',
    editorMoveBlock: '移动',
    editorIndentBlock: '缩进',
    editorOutdentBlock: '反缩进',
    editorMoveTapCancel: '点此取消',
    editorTurnInto: '转换为',
    editorDuplicate: '复制块',
    editorCopyBlocks: '复制',
    editorPasteBlocks: '粘贴',
    editorPastedBlocks: '已粘贴为块',
    editorSlashFilter: '搜索…',
    editorSlashNoMatch: '没有匹配的类型',
    editorBlockMenuTitle: '操作',
    editorBlockTypeImage: '图片',
    editorInsertBelow: '在下面插入',
    editorReplaceImage: '替换',
    editorCaption: '标题',
    editorCaptionPlaceholder: '添加标题…',
    editorAlign: '对齐',
    editorAlignLeft: '左对齐',
    editorAlignCenter: '居中',
    editorAlignFull: '全宽',
    editorMoreOptions: '更多选项',
    editorCopyImageLink: '拷贝图片链接',
    editorImageLinkCopied: '图片链接已复制',
    editorBlockDeleted: '块已删除',
    editorUndoBlockDelete: '撤销',
    editorUndo: '撤销',
    editorRedo: '重做',
    editorFormatBold: '加粗',
    editorFormatItalic: '斜体',
    editorFormatCode: '行内代码',
    editorTurnIntoUnavailable: '即将推出',
    editorAiImageBlockHint: '帮我处理这个图片块…',
