    ...
    <View ref={rowRef} collapsable={false}>
      ...
      >
        <View style={[styles.iconBubble, styles.actionIconBubble]}>
          <Icon source="creation-outline" size={16} color="#6D5DFB" />
        </View>
        <View style={styles.itemCopy}>
          <Text numberOfLines={1} style={[styles.itemTitle, { color: colors.text.primary }]}>问 AI</Text>
          <Text numberOfLines={1} style={[styles.itemSubtitle, { color: colors.text.tertiary }]}>开始新对话</Text>
        </View>
        <Icon source="chevron-right" size={18} color={colors.text.tertiary} />
      </AnimatedPressable>
    </View>
