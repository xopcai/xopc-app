...
参考：`SessionCard.tsx`、`SessionsScreen.tsx`  
**待迁移**：长按 Dropdown → 多选；补 `SwipeableRow`；清理 `SessionActionPopover`。
...
| **P2** | Sessions 左滑 + 多选；废弃 Menu / `SessionActionPopover` |
